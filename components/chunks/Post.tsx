        ...
        >
            <section className='p-md'>
                ...
                <p className='paragraph-sm text-skin-text my-sm'>
                    ...
                    Molestiae pariatur obcaecati recusandae tempore
                    reprehenderit officia aut culpa deleniti ducimus, blanditiis
                    aliquam consequuntur ipsam ullam! Possimus fugit veniam
                    ipsam voluptas id! Lorem ipsum dolor sit amet consectetur
                    adipisicing elitee.
                </p>

                <span className='text-skin-text-light text-xs'>
                    5 hours ago
                </span>
            </section>
