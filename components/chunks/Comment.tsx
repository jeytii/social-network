...
export default function Comment({ className, ...props }: Props) {
    return (
        <article className={clsx('bg-skin-bg-contrast rounded-md p-md', className)} {...props}>
            <BasicInfo imageUrl="/" imageSize={40} gender="Male" name="John doe" username="5 hours ago" />
