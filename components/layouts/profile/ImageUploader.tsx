        ...
        <section>
            {loading ? (
                ...
                <div className="relative block w-[100px] rounded-full overflow-hidden m-auto">
                    <MdAccountCircle className="text-skin-text-light block w-full h-full" viewBox="2 2 20 20" />
                    ...
                    <label className="absolute w-full bottom-[0px] py-sm cursor-pointer" style={{ background: 'rgba(0, 0, 0, 0.5)' }} htmlFor="upload">
                        <input className="hidden" type="file" id="upload" />
                        <MdCameraAlt className="block m-auto" size={20} fill="#fff" />
                    </label>
                </div>
            )}
